<template>
    <app-layout :title="`Edit ${userForm.data.title}`">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ `Edit ${userForm.data.title}` }}
            </h2>
        </template>
...
export default defineComponent({
    ...
    data() {
        return {
            form: useForm({
                title: this.userForm.data.title,
                description: this.userForm.data.description,
                questions: this.userForm.data.questions,
            }),
        };
    },
    methods: {
